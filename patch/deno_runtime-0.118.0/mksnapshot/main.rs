// deno_runtime-0.118.0/mksnapshot
// code from deno_runtime-0.118.0/build.rs
// only for aarch64-linux-android
...
fn main() {
    ...
    println!("deno-mksnapshot-runtime: deno_runtime-0.118.0");
    ...
    println!("  {}", runtime_snapshot_path.display());
    startup_snapshot::create_runtime_snapshot(runtime_snapshot_path);

    println!("deno-mksnapshot-runtime: done");
}
